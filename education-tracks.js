...
(function (global) {
  var TRACKS = [
    ...
    },
    {
      ...
      blurb:
        'Think: the robot from childhood, the mind-meld goal. Wearable and mergeable tech built in real time so presence can outlast the body. First iteration: next Tesla vehicle as mobile command center. Last: when the last functioning biological cell is ejected. We hold architectural plans; you contribute interfaces, embodiment, and honest evidence of what actually continues—and win a seat in the build.',
      safetyNote:
